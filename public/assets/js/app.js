...
const APP = (() => {
  ...
  function renderHeader(activePage) {
    ...
    const links = [
      ["index.html", "गृहपृष्ठ"],
      ["directory.html", "सदस्य निर्देशिका"],
      ["leadership.html", "नेतृत्व"],
      ["committees.html", "समितिहरू"],
      ["statistics.html", "तथ्याङ्क"],
      ["downloads.html", "डाउनलोड"],
      ["about.html", "बारेमा"],
    ];
    ...
    mount.innerHTML = `
      <div class="container">
        <a class="brand" href="index.html">
          ...
          <span class="brand-title">संघीय संसद सम्पर्क निर्देशिका
            <span class="sub">Federal Parliament Contact Directory</span>
          </span>
        </a>
  ...
  function renderFooter() {
    ...
    mount.innerHTML = `
      <div class="container">
        <div>© ${year} संघीय संसद सचिवालय — Federal Parliament Secretariat, Singha Durbar, Kathmandu</div>
        <div class="footer-links">
          <a href="about.html">बारेमा</a>
          <a href="downloads.html">डाउनलोड</a>
  ...
  /* ---------------- English name display toggle (ने/EN) ---------------- */
  function initLangToggle() {
    const mount = document.getElementById("langToggleMount");
    if (!mount) return;
    const hideEn = localStorage.getItem("npd-hide-en") === "1";
    document.body.toggleAttribute("data-i18n-hide-en", hideEn);
    mount.innerHTML = `
      <div class="lang-toggle" role="group" aria-label="अङ्ग्रेजी नाम देखाउने/लुकाउने">
        <button type="button" data-mode="show" class="${hideEn ? "" : "active"}">ने+EN</button>
        <button type="button" data-mode="hide" class="${hideEn ? "active" : ""}">ने</button>
      </div>`;
    mount.querySelectorAll("button").forEach(btn => {
      btn.addEventListener("click", () => {
        const hide = btn.dataset.mode === "hide";
        document.body.toggleAttribute("data-i18n-hide-en", hide);
        localStorage.setItem("npd-hide-en", hide ? "1" : "0");
        mount.querySelectorAll("button").forEach(b => b.classList.toggle("active", b === btn));
      });
    });
  }
